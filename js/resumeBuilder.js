...
var education = {
    "schools": [{
        ...
        "dates": "2004-2006",
        "majors": ["Web Development", "Multimedia Project Management", "Web programming", "User Experience Design"],
        "location": "Melbourne, Australia",
        "url": "http://www.swinburne.edu.au/study/course/Master-of-Multimedia-MA-MM1/international"
    }, {
        "name": "Keyframes Institute of Technology",
        "degree": "Diploma in Multimedia",
        "dates": "2001-2003",
        "majors": ["Graphic Design", "2D & 3D Animations"],
        "location": "Ahmedabad, India"
    }],
    "onlineCourses": [{
        "title": "Up and Running with AngularJS 1",
        "school": "Lynda.com",
        "dates": "Jun 2015",
...
education.display = function() {
    ...
    education.schools.forEach(function(school) {
        var schooldegree = HTMLschoolName.replace("%data%", school.name) + HTMLschoolDegree.replace("%data%", school.degree);
        console.log("schooldegree: "+ schooldegree);
